...
Guidelines:
1. Use the exec_command tool to explore the codebase (navigate to /workspace directory)
2. Look for features like authentication, payments, dashboards, forms, API endpoints, etc.
